...
?>
<div class="content">
  <form class="question-search" method="get" action="<?= htmlspecialchars($basePath, ENT_QUOTES, 'UTF-8'); ?>/admin/questions/index.php">
    ...
    <?php if ($searchTerm !== ''): ?>
      <a class="reset-link" href="<?= htmlspecialchars($basePath, ENT_QUOTES, 'UTF-8'); ?>/admin/questions/index.php">Clear filter</a>
    <?php endif; ?>
  </form>
      ...
      <?php foreach ($questions as $question): ?>
        <tr>
          ...
          <td class="question-edit">
            <a href="<?= htmlspecialchars($basePath, ENT_QUOTES, 'UTF-8'); ?>/admin/questions/editquestion.php?id=<?= (int) $question['id'] ?>">Edit</a>
          </td>

          <td class="question-delete">
            <form action="<?= htmlspecialchars($basePath, ENT_QUOTES, 'UTF-8'); ?>/admin/questions/deletequestion.php" method="post">
